...
CONFIGS={"G01","G02","G03","G04"}; WINDOWS={"2020_2021","2021_2022","2022_2023","2023_2024","2024_2025"}; EXPECTED={(c,w) for c in CONFIGS for w in WINDOWS}
def sha(p):
 h=hashlib.sha256();
 with p.open('rb') as f:
...
def main():
 ...
 mp=r/'architecture_g_manifest.json'
 ...
 print('Verification PASSED: Architecture G 20/20 artifact verified.');return 0
