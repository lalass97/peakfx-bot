...
EXPECTED_CONFIGS = {"C01", "C02", "C03", "C04"}
...
def main() -> int:
    ...
    manifest_path = root / "architecture_c_manifest.json"
    ...
    copies = [
        (frozen / "PeakFX_EURUSD_ARCH_C_SESSION_EXHAUSTION.mq5", src, "source"),
        (frozen / "PeakFX_EURUSD_ARCH_C_SESSION_EXHAUSTION.ex5", binh, "binary"),
        (frozen / "ARCHITECTURE_C_FROZEN_BASELINE_SPEC.md", spec, "specification"),
    ]
    ...
    if errors:
        ...
        return 1
    print("Verification PASSED: Architecture C 20/20 artifact verified.")
    return 0
