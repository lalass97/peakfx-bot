...
EXPECTED_CONFIGS = {"D01", "D02", "D03", "D04"}
...
def main() -> int:
    ...
    manifest_path = root / "architecture_d_manifest.json"
    ...
    copies = [
        (frozen / "PeakFX_EURUSD_ARCH_D_IMPULSE_PULLBACK.mq5", src, "source"),
        (frozen / "PeakFX_EURUSD_ARCH_D_IMPULSE_PULLBACK.ex5", binh, "binary"),
        (frozen / "ARCHITECTURE_D_FROZEN_BASELINE_SPEC.md", spec, "specification"),
    ]
    ...
    if errors:
        ...
        return 1
    print("Verification PASSED: Architecture D 20/20 artifact verified.")
    return 0
