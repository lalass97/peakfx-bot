...
$old='Expert=PeakFX\PeakFX_EURUSD_ARCH_B_VOLATILITY_EXPANSION'
$new='Expert=PeakFX\PeakFX_EURUSD_ARCH_B_VOLATILITY_EXPANSION.ex5'
if($text-notlike "*$old*"){throw 'Expected Architecture B Expert line not found in base runner'}
